...
<form action="search-studentattendance.php" class="form_box d-flex justify-content-between w-100" method="post" name="search">
<input type="text" placeholder="Search by Usn" class="form-control" name="searchteacher">

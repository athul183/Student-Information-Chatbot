...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT email FROM tblregister WHERE email=:email and mobile=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblregister set newpassword=:newpassword where email=:email and mobile=:mobile";
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                     <p class="login-img"><img class="headerc" src="images/header.jpg" style="max-width:600px;"></p>
                    <hr  color="red"/>
                </div>

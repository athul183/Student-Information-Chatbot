...
<body>
   ...
   <?php include_once('includes/header.php');?>
	...
	<center>
	<a href="attendance.php"><h3 style="color:red;">Go BACK</h3></a>
	</center>
...
$sdata=$_POST['searchteacher'];
  ?>
  <h4 align="left">Result against "<?php echo $sdata;?>" Attendance </h4> 
...
$sql="SELECT * from tblattendance where usn='$sdata'";
...
{               ?>   
                ...
                <tr>
                  ...
                  <td><?php  echo htmlentities($row->usn);?></td>
